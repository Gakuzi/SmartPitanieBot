...
### 8.7. Задача: Восстановление основного функционала бота

*   **Статус:** В работе.
*   **Цель:** Устранить критические ошибки, мешающие базовому взаимодействию с ботом: починить отображение клавиатуры, корректно обрабатывать команды и улучшить форматирование ответов AI.
*   **Этапы:**
    *   **Этап 1: Ремонт клавиатуры (Выполнено)**
    *   **Этап 2: Обучение AI форматированию (Выполнено)**
    *   **Этап 3: Восстановление логики команд (Выполнено)**
